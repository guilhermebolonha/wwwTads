...
public static ContaPoupanca consultaContaPPSW(Agencia agenciaAux, int codConta1) {
...
public static ContaCorrente consultaContaCCSW(Agencia agenciaAux, int codConta2) {
	boolean encontrou = false;
	ContaCorrente contaAux2 = new ContaCorrente(codConta2);
	int index2 = agenciaAux.getLstContas().indexOf(contaAux2);
